...
export class ListTodosComponent implements OnInit {
  ...
  ngOnInit() {
    this.isUserAdmin = this.authService
  ...
  refreshTodos() {
    this.todoService
      .retrieveAllTodos(this.authService.getAuthenticatedUser())
      .subscribe(response => {
  ...
  refreshTodosAdmin() {
    ...
    this.todoService.retrieveAllTodosAdmin().subscribe(response => {
      console.log(response);
      this.todos = response;
    });
  }
  ...
  deleteTodo(id) {
    ...
    this.todoService
      .deleteTodo(this.authService.getAuthenticatedUser(), id)
      .subscribe(response => {
        console.log(response);
