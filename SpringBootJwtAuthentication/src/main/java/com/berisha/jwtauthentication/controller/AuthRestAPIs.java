...
import com.berisha.jwtauthentication.message.request.LoginForm;
import com.berisha.jwtauthentication.message.request.SignUpForm;
import com.berisha.jwtauthentication.model.Role;
import com.berisha.jwtauthentication.repository.UserRepository;
import com.berisha.jwtauthentication.security.jwt.JwtProvider;
...
import com.berisha.jwtauthentication.message.response.JwtResponse;
...
public class AuthRestAPIs {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignUpForm signUpRequest) {
        ...
        return new ResponseEntity<String>("User Created successfuly !",
                HttpStatus.OK);
    }
}